...
const faqData = [
  ...
  {
    question: 'ダウンロードした動画の保存場所はどこですか？',
    answer: 'ブラウザの設定により、通常は「ダウンロード」フォルダに保存されます。ブラウザの設定から保存場所を変更することも可能です。'
  },
  {
    question: '動画の音声のみをダウンロードすることはできますか？',
    answer: '現在、音声のみの抽出機能は提供していません。動画ファイルをダウンロードした後、別のツールを使用して音声を抽出してください。'
  }
];
